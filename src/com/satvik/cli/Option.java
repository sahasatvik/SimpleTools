...
public class Option<T> {
	 ...
	 * 	@throws	com.satvik.cli.IncorrectOptionSyntaxException	thrown if there is a syntax error while invoking the constructor
	 * 	@since	1.0
	 */
	 ...
	 * 	@return				this Option
	 * 	@throws	com.satvik.cli.UnknownOptionValueTypeException		thrown if valueTypeClass does not belong to the list of accepted classes
	 * 	@throws	com.satvik.cli.CannotParseValueOfOptionException	thrown if the Option cannot carry a value
	 * 	@since	1.0
	 */
	 ...
	 * 	@return				this Option
	 * 	@throws	com.satvik.cli.CannotParseValueOfOptionException	thrown if canHaveValue is false
	 * 	@since	1.2
	 */
	 ...
	 * 	@throws	com.satvik.cli.CannotParseValueOfOptionException	thrown if there is an error in prsing the raw String, or the Option cannot carry  value
	 * 	@since	1.0
	 */
	 ...
	 * 	@throws	com.satvik.cli.MissingOptionValueException	thrown if the Option is empty
	 * 	@throws	com.satvik.cli.CannotParseValueOfOptionException	thrown if the Option cannot carry a value
	 * 	@since	1.0
	 */
