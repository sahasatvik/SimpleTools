...
public class Flag<T> {
	 ...
	 * 	@throws	com.satvik.cli.IncorrectFlagSyntaxException	thrown if there is s syntax error while invoking the constructor
	 * 	@since	1.0
	 */
	 ...
	 * 	@return				this Flag
	 * 	@throws	com.satvik.cli.UnknownFlagValueTypeException	thrown if valueTypeClass does not belong to the list of accepted classes
	 * 	@throws	com.satvik.cli.CannotParseValueOfFlagException	thrown if the Flag cannot carry a value
	 * 	@since	1.0
	 */
	 ...
	 * 	@return				this Flag
	 * 	@throws	com.satvik.cli.CannotParseValueOfFlagException	thrown if canHaveValue is false
	 * 	@since	1.2
	 */
	 ...
	 * 	@throws	com.satvik.cli.CannotParseValueOfFlagException	thrown if there is an error in prsing the raw String, or the Flag cannot carry  value
	 * 	@since	1.0
	 */
	 ...
	 * 	@throws	com.satvik.cli.MissingFlagValueException	thrown if the Flag is empty
	 * 	@throws	com.satvik.cli.CannotParseValueOfFlagException	thrown if the Flag cannot carry a value
	 * 	@since	1.0
	 */
